...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        users_data = [
            {'username':'safararijadi@gmail.com', 'password': 'Safa1234!!', 'email': 'safararijadi@gmail.com'},
            {'username':'annisa.kurnia97@gmail.com', 'password': 'Toefl-01-Annisa', 'email': 'annisa.kurnia97@gmail.com'},
