...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        users_data = [
            {'username':'adityafardit@gmail.com', 'password': 'adityafardit!!', 'email': 'adityafardit@gmail.com'},
            {'username':'arkangrd@gmail.com', 'password': 'arkangrd!!', 'email': 'arkangrd@gmail.com'},
