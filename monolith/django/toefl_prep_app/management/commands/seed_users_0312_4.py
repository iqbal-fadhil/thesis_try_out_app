...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        users_data = [
            {'username': 'zikraalifi@gmail.com', 'password': 'zikraalifi', 'email': 'zikraalifi@gmail.com'},
            {'username': 'haipazuhairaa@gmail.com', 'password': 'haipazuhairaa', 'email': 'haipazuhairaa@gmail.com'},
            {'username': 'pasqualito@student.telkomuniversity.ac.id', 'password': 'pasqualito', 'email': 'pasqualito@student.telkomuniversity.ac.id'},                      
        ]
