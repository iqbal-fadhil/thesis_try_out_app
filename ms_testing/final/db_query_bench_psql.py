...
ARCHITECTURE_NAME = "php_postgres"  # jawaban di grafik nanti bisa dipisah per kombinasi
DBMS_NAME = "postgresql"           # atau "mysql", dll

# Sesuaikan DSN untuk varian ini
DSN = "host=localhost port=5432 user=ms_php_user password=yourStrongPassword123 dbname=test_php_service_db sslmode=disable"
